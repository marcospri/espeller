...
var _user$project$Main$genericSpelling = F2(
	function (dictionary, letter) {
		var keyCode = _elm_lang$core$Char$toCode(letter) - 97;
		var spelling = A2(_elm_lang$core$Array$get, keyCode, dictionary);
		var _p0 = spelling;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
...
var _user$project$Main$spanishSpellingArray = _elm_lang$core$Array$fromList(
	_elm_lang$core$Native_List.fromArray(
		['ei', 'bi', 'si', 'di', 'i', 'ef', 'gi', 'eich', 'ai', 'yei', 'kei', 'el', 'em', 'en', 'ou', 'pi', 'quiu', 'ar', 'es', 'ti', 'iu', 'vi', 'dabliu', 'ex', 'guay', 'sed']));
var _user$project$Main$spanishSpelling = function (letter) {
	return A2(_user$project$Main$genericSpelling, _user$project$Main$spanishSpellingArray, letter);
};
var _user$project$Main$natoSpellingArray = _elm_lang$core$Array$fromList(
	_elm_lang$core$Native_List.fromArray(
		['Alpha', 'Bravo', 'Charlie', 'Delta', 'Echo', 'Foxtrot', 'Golf', 'Hotel', 'India', 'Juliet', 'Kilo', 'Lima', 'Mike', 'November', 'Oscar', 'Papa', 'Quebec', 'Romeo', 'Sierra', 'Tango', 'Uniform', 'Victor', 'Whiskey', 'X-Ray', 'Yankee', 'Zulu']));
var _user$project$Main$natoSpelling = function (letter) {
	return A2(_user$project$Main$genericSpelling, _user$project$Main$natoSpellingArray, letter);
};
var _user$project$Main$renderLetter = function (letter) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('col s6 m2 l2')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('card center-align')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('chip')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_user$project$Main$natoSpelling(letter))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_user$project$Main$spanishSpelling(letter))
							]))
					]))
			]));
};
...
var _user$project$Main$view = function (model) {
	var letterCards = A2(
		_elm_lang$core$List$map,
		_user$project$Main$renderLetter,
		_elm_lang$core$String$toList(model));
	return A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text('¿Qué quieres deletrear?')
													]))
											])),
										A2(
										_elm_lang$html$Html$div,
